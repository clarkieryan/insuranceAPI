...
class IncidentsControllerTest < ActionController::TestCase
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post :create, incident: { date: @incident.date, desc: @incident.desc, type: @incident.type, value: @incident.value }
    end
  ...
  test "should update incident" do
    patch :update, id: @incident, incident: { date: @incident.date, desc: @incident.desc, type: @incident.type, value: @incident.value }
    assert_redirected_to incident_path(assigns(:incident))
  end
